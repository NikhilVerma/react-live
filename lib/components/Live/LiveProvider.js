...
var _Style = require('../Editor/Style');
...
var LiveProvider = function (_Component) {
  ...
  function LiveProvider() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.onChange = function (code) {
      _this.transpile(code, _this.props.scope, _this.props.noInline);
    }, _this.onError = function (error) {
      _this.setState({ error: error.toString() });
    }, _this.transpile = function (code, scope) {
      var noInline = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  ...
  LiveProvider.prototype.componentWillReceiveProps = function componentWillReceiveProps(_ref) {
    var code = _ref.code,
        scope = _ref.scope,
        noInline = _ref.noInline;

    if (code !== this.props.code || scope !== this.props.scope || noInline !== this.props.noInline) {
      this.transpile(code, scope, noInline);
    }
  };
  ...
  LiveProvider.prototype.render = function render() {
    var _props2 = this.props,
        ...
        rest = _objectWithoutProperties(_props2, ['children', 'className', 'code', 'mountStylesheet', 'noInline']);
